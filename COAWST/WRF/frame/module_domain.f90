...
IF ( ASSOCIATED( grid%scalar_bxe ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3977,&
...
IF ( ASSOCIATED( grid%avgflx_cfu1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11526,&
...
IF ( ASSOCIATED( grid%avgflx_dfu1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11540,&
...
IF ( ASSOCIATED( grid%efd1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11603,&
...
IF ( ASSOCIATED( grid%spstreamforcs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11722,&
...
IF ( ASSOCIATED( grid%spforcc4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11820,&
...
IF ( ASSOCIATED( grid%vertampuv ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11890,&
...
IF ( ASSOCIATED( grid%rand_real_xxx ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11939,&
...
IF ( ASSOCIATED( grid%qpert2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12002,&
...
IF ( ASSOCIATED( grid%wsedl3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12030,&
...
IF ( ASSOCIATED( grid%precz ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12051,&
...
IF ( ASSOCIATED( grid%evapqzm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12107,&
...
IF ( ASSOCIATED( grid%pconvb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12163,&
...
IF ( ASSOCIATED( grid%pconvt ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12170,&
...
IF ( ASSOCIATED( grid%pc_btys ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16551,&
...
IF ( ASSOCIATED( grid%i_wif_dec ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16833,&
...
IF ( ASSOCIATED( grid%temperature ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16847,&
...
IF ( ASSOCIATED( grid%geoheight ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16854,&
...
IF ( ASSOCIATED( grid%dir ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16889,&
...
IF ( ASSOCIATED( grid%lakemask ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16903,&
   ...
   END SUBROUTINE init_module_domain
      ...
      FUNCTION domain_get_stop_time ( grid ) RESULT ( stop_time ) 
        ...
        CALL WRFU_ClockGet( grid%domain_clock, StopTime=stop_time, &
                            rc=rc )
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",17071,&
      ...
      SUBROUTINE domain_clockadvance ( grid )
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",17692,&
      ...
      SUBROUTINE domain_setgmtetc ( grid, start_of_simulation )
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",17723,&

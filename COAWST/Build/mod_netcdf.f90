      MODULE mod_netcdf
!
!svn $Id: mod_netcdf.F 927 2018-10-16 03:51:56Z arango $
!================================================== Hernan G. Arango ===
...
!
      character (len=40) :: att_name(Matts)      ! attribute names
      character (len=40) :: dim_name(Mdims)      ! dimension names
      character (len=40) :: var_name(Mvars)      ! variable names
!
...
!
     ...
     &                                    dim_name(i), dim_size(i))
            IF (FoundError(status, nf90_noerr, 331,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //                                  &
     &                     ", netcdf_get_dim")) THEN
...
!
     ...
     &                       ncid = ncid)
      END IF
      IF (FoundError(exit_flag, NoError, 699,                           &
     &               "ROMS/Modules/mod_netcdf.F" //                                        &
...
!
     ...
     &                              ncid = ncid)
            END IF
            IF (FoundError(exit_flag, NoError, 720,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //                                  &
     &                     ", netcdf_check_var")) RETURN
     ...
     &                              ncid = ncid)
            END IF
            IF (FoundError(exit_flag, NoError, 802,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //                                  &
     &                     ", netcdf_check_var")) RETURN
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 1423,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     ...
     &                            TRIM(SourceFile)
        ...
        ELSE
          IF (n_var.gt.Mvars) THEN
            ...
            exit_flag=2
          END IF
          IF (FoundError(status, nf90_noerr, 1509,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_inq_var")) THEN
...
!
     ...
     &                                      var_Dname(i), var_Dsize(i))
              IF (FoundError(status, nf90_noerr, 1597,                  &
     &                       "ROMS/Modules/mod_netcdf.F" //                                &
     &                       ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Aint(i))
                      IF (FoundError(status, nf90_noerr, 1622,          &
     &                               "ROMS/Modules/mod_netcdf.F" //                        &
     &                               ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Afloat(i))
                      IF (FoundError(status, nf90_noerr, 1641,          &
     &                               "ROMS/Modules/mod_netcdf.F" //                        &
     &                               ", netcdf_inq_var")) THEN
...
!
      IF (InpThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 1818,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 1926,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
     ...
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 1952,              &
     &                           "ROMS/Modules/mod_netcdf.F" //                            &
            ...
            IF (status.eq.nf90_noerr) THEN
              DO i=1,natts
                IF (TRIM(my_Aname).eq.TRIM(AttName(i))) THEN
                  status=nf90_get_att(my_ncid, varid, TRIM(AttName(i)), &
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 2143,              &
     &                           "ROMS/Modules/mod_netcdf.F" //                            &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2314,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 2344,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2537,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2759,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2788,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3014,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3043,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3280,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3521,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3695,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_lvar")) RETURN
      ELSE
        my_ncid=ncid
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3740,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //                                  &
     &                     ", netcdf_get_lvar")) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3868,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3886,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4004,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4021,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4140,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4157,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4301,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4424,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_svar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4441,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4564,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_svar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4581,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4703,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_svar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4720,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4869,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4887,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5165,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 5848,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5860,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 5881,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5989,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6001,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 6017,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6125,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6137,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6154,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6263,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6275,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6292,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6401,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6413,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6430,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6541,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6553,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 6575,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6684,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6696,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6713,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6822,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6834,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6851,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6966,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6978,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 7009,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7123,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7135,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 7163,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7277,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7289,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, AI, start, total)
          IF (FoundError(status, nf90_noerr, 7319,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7438,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7450,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7467,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7588,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_svar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7600,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7617,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7736,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_svar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7748,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7764,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7882,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_put_svar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7894,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7910,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 8078,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_close")) THEN
...
!
      ...
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8201,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_create")) THEN
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 8214,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                                    &
     &                   ", netcdf_create")) THEN
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8301,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_enddef")) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          PRINT *, trim(nf90_strerror(status))
      ...
      IF (InpThread) THEN
        SELECT CASE (omode)
          ...
          CASE DEFAULT
            status=nf90_open(TRIM(ncname), nf90_nowrite, ncid)
        END SELECT
        IF (FoundError(status, nf90_noerr, 8429,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_open")) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          exit_flag=3
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8511,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_redef")) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          PRINT *, trim(nf90_strerror(status))
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8588,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                                      &
     &                 ", netcdf_sync")) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          PRINT *, trim(nf90_strerror(status))

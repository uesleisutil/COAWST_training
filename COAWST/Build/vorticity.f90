...
!
!svn $Id: vorticity.F 905 2018-06-20 21:08:33Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 5, 76, "ROMS/Utility/vorticity.F")
     ...
     &                     AVERAGE(ng) % avgrvor2d)
      CALL wclock_off (ng, iNLM, 5, 114, "ROMS/Utility/vorticity.F")
      RETURN

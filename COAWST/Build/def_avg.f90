...
!
      SourceFile="ROMS/Utility/def_avg.F"
!
!-----------------------------------------------------------------------
...
!
     ...
     &                 IOBOUNDS(ng)%xi_psi, DimIDs( 4))
        IF (FoundError(exit_flag, NoError, 143,                         &
     &                 "ROMS/Utility/def_avg.F")) RETURN
     ...
     &                 nf90_unlimited, DimIDs(12))
        IF (FoundError(exit_flag, NoError, 293,                         &
     &                 "ROMS/Utility/def_avg.F")) RETURN
        recdim=DimIDs(12)
!
...
!
     ...
     &                   NF_FOUT, nvd3, u2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 524,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 565,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 607,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 627,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 823,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 842,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 862,                       &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                     NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
            IF (FoundError(exit_flag, NoError, 890,                     &
     &                     "ROMS/Utility/def_avg.F")) RETURN
          END IF
        END DO
!
...
!
     ...
     &                   NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1177,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                 NF_FOUT, nvd3, p2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1379,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, p3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1399,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, p3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1418,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1476,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1553,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                     nvd4, t3dgrd, Aval, Vinfo, ncname)
            IF (FoundError(exit_flag, NoError, 1593,                    &
     &                     "ROMS/Utility/def_avg.F")) RETURN
          END IF
        END DO
!
...
!
     ...
     &                     nvd4, u3dgrd, Aval, Vinfo, ncname)
            IF (FoundError(exit_flag, NoError, 1615,                    &
     &                     "ROMS/Utility/def_avg.F")) RETURN
          END IF
!
...
!
     ...
     &                     nvd4, u3dgrd, Aval, Vinfo, ncname)
            IF (FoundError(exit_flag, NoError, 1655,                    &
     &                     "ROMS/Utility/def_avg.F")) RETURN
          END IF
!
     ...
     &                     nvd4, v3dgrd, Aval, Vinfo, ncname)
            IF (FoundError(exit_flag, NoError, 1673,                    &
     &                     "ROMS/Utility/def_avg.F")) RETURN
          END IF
        END DO
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname,    &
     &                   SetFillVal = .FALSE.)
          IF (FoundError(exit_flag, NoError, 1710,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1893,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1937,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1958,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1980,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2000,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2024,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, u2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2045,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2064,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, u2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2083,                      &
     &                   "ROMS/Utility/def_avg.F")) RETURN
        END IF
!
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3611,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3634,                        &
     &                 "ROMS/Utility/def_avg.F")) THEN
...
!
     ...
     &                         ncid = AVG(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 3644,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!
...
!
     ...
     &                       ncid = AVG(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 3651,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!

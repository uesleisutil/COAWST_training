...
!
!svn $Id: mp_exchange.F 923 2018-09-26 21:20:30Z arango $
!================================================== Hernan G. Arango ===
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 60, 895,                              &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange2d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 972,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 1402,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange2d_bry")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 61, 1483,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 61, 2118,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange3d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 2195,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 2738,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange3d_bry")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 62, 2822,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 62, 3416,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange4d")
      RETURN

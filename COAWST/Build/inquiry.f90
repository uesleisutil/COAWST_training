...
!
!svn $Id: inquiry.F 927 2018-10-16 03:51:56Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                                    TRIM(Fname)
            exit_flag=4
            IF (FoundError(exit_flag, NoError, 306,                     &
     &                     "ROMS/Utility/inquiry.F")) RETURN
          END IF
        END IF
...
!
      IF (ncid.eq.-1) THEN
        ...
        IF (FoundError(exit_flag, NoError, 482,                         &
     &                 "ROMS/Utility/inquiry.F")) THEN
...
!
     ...
     &                            start = (/Trec-1/),                   &
     &                            total = (/1/))
            IF (FoundError(exit_flag, NoError, 557,                     &
     &                     "ROMS/Utility/inquiry.F")) THEN

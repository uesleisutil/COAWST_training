...
!
     ...
     &                 "/home/ueslei/Documents/INPE/COAWST_training/COAWST/ROMS/Drivers/nl_ocean.h")) RETURN
!
...
!$OMP PARALLEL
          DO thread=MyRank,MyRank
            CALL wclock_on (ng, iNLM, 0, 148, "/home/ueslei/Documents/INPE/COAWST_training/COAWST/ROMS/Drivers/nl_ocean.h")
          END DO
!$OMP END PARALLEL
        END DO
!
...
!$OMP END PARALLEL
      IF (FoundError(exit_flag, NoError, 320,                           &
     &               "/home/ueslei/Documents/INPE/COAWST_training/COAWST/ROMS/Drivers/nl_ocean.h")) RETURN
!
...
!$OMP PARALLEL
        DO thread=MyRank,MyRank
          CALL wclock_off (ng, iNLM, 0, 424, "/home/ueslei/Documents/INPE/COAWST_training/COAWST/ROMS/Drivers/nl_ocean.h")
        END DO
!$OMP END PARALLEL
      END DO
!

      MODULE mod_ncparam
!
!svn $Id: mod_ncparam.F 927 2018-10-16 03:51:56Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (.not.allocated(idefAVG)) THEN
        ...
        Dmem(1)=Dmem(1)+REAL(Ngrids,r8)
      END IF
      IF (.not.allocated(idefAVG2)) THEN
      ...
      IF (.not.allocated(idefHIS)) THEN
        ...
        Dmem(1)=Dmem(1)+REAL(Ngrids,r8)
      END IF
      IF (.not.allocated(idefHIS2)) THEN

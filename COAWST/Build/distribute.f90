...
!
!svn $Id: distribute.F 927 2018-10-16 03:51:56Z arango $
!================================================== Hernan G. Arango ===
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 72, 133,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 72, 150,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_barrier")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 367,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 395,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastf")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 477,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastf")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 531,                               &
     &                "ROMS/Utility/distribute.F"//":mp_bcastf")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 562,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastf")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 616,                               &
     &                "ROMS/Utility/distribute.F"//":mp_bcastf")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 648,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastf")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 702,                               &
     &                "ROMS/Utility/distribute.F"//":mp_bcastf")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 735,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastf")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 786,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 813,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcasti")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 865,                               &
     &                "ROMS/Utility/distribute.F"//":mp_bcasti")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 894,                              &
     &                 "ROMS/Utility/distribute.F"//":mp_bcasti")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 947,                               &
     &                "ROMS/Utility/distribute.F"//":mp_bcasti")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 978,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcasti")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1030,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1058,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastl")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1110,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcastl")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1139,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastl")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1192,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcastl")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1223,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcastl")
      RETURN
...
!
      IF (Lwclock) THEN
        CALL wclock_on (ng, model, 64, 1275,                            &
...
!
      IF (Lwclock) THEN
        CALL wclock_off (ng, model, 64, 1305,                           &
     &                   "ROMS/Utility/distribute.F"//":mp_bcasts")
      END IF
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1358,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcasts")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1388,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcasts")
      RETURN
      END SUBROUTINE mp_bcasts_1d
!
      SUBROUTINE mp_bcasts_2d (ng, model, A)
!
!***********************************************************************
!                                                                      !
!  This routine broadcasts a 2D nontiled,  string array to all         !
!  processors processors in the group. It is called by all the         !
!  members in the group.                                               !
!                                                                      !
!  On Input:                                                           !
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1441,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcasts")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1472,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcasts")
      RETURN
      END SUBROUTINE mp_bcasts_2d
!
      SUBROUTINE mp_bcasts_3d (ng, model, A)
!
!***********************************************************************
!                                                                      !
!  This routine broadcasts a 3D nontiled,  string array to all         !
!  processors processors in the group. It is called by all the         !
!  members in the group.                                               !
!                                                                      !
!  On Input:                                                           !
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 64, 1525,                              &
     &                "ROMS/Utility/distribute.F"//":mp_bcasts")
!
!-----------------------------------------------------------------------
!  Broadcast requested variable.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 64, 1557,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_bcasts")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 68, 1634,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 68, 1737,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_boundary")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 70, 1806,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 70, 1957,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_assemble")
!
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 70, 2039,                              &
     &                "ROMS/Utility/distribute.F"//":mp_assemble")
!
!-----------------------------------------------------------------------
!  Check input parameters.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 70, 2205,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_assemble")
!
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 70, 2287,                              &
     &                "ROMS/Utility/distribute.F"//":mp_assemble")
!
!-----------------------------------------------------------------------
!  Check input parameters.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 70, 2454,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_assemble")
!
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 70, 2532,                              &
     &                "ROMS/Utility/distribute.F"//":mp_assemble")
!
!-----------------------------------------------------------------------
!  Check input parameters.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 70, 2683,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_assemble")
!
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 70, 2764,                              &
     &                "ROMS/Utility/distribute.F"//":mp_assemble")
!
!-----------------------------------------------------------------------
!  Check input parameters.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 70, 2931,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_assemble")
!
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 69, 3008,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 69, 3142,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_collect")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 69, 3211,                              &
     &                "ROMS/Utility/distribute.F"//":mp_collect")
!
!-----------------------------------------------------------------------
!  Collect data from all nodes.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 69, 3345,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_collect")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 66, 3447,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 66, 3679,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_gather2d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 66, 3783,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 66, 4036,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_gather3d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 66, 4101,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 66, 4184,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_gather_state")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 67, 4265,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 67, 4394,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_ncread1d")
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 67, 4484,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 67, 4623,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_ncread2d")
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 66, 4711,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 66, 4846,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_ncwrite1d")
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 66, 4936,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 66, 5081,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_ncwrite2d")
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 65, 5547,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 65, 5665,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_reduce")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 65, 5733,                              &
     &                "ROMS/Utility/distribute.F"//":mp_reduce")
!
!-----------------------------------------------------------------------
!  Collect and reduce requested scalar variables.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 65, 5867,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_reduce")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 65, 5932,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 65, 5989,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_reduce2")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 67, 6079,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 67, 6262,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_scatter2d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 67, 6354,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 67, 6550,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_scatter3d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 67, 6620,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 67, 6718,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_scatter_state")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 71, 6917,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 71, 7048,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_aggregate2d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 71, 7130,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 71, 7267,                             &
     &                 "ROMS/Utility/distribute.F"//":mp_aggregate3d")
      RETURN
